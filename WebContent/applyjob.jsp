        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="details.html" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Fill Personal Details</a>
...
<%
	...
	PreparedStatement psmt=con.prepareStatement("select * from job ");
                        ...
                        <div class=" h-100 p-4">
                            ...
                            <table class="table">
                               ...
                               <% while(rs.next()){%>
									...
									<td> <a href="newjobid.jsp?jid=<%= rs.getInt(1) %>">Apply</a></td>
								</tr>		
