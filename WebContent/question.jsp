...
<%	int qno=1;
	...
	PreparedStatement psmt=con.prepareStatement("select * from question ");
                     ...
                     <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                ...
                                <button type="submit" class="btn btn-primary py-3 w-100 mb-4"><a href="exam.jsp">Submit</a></button>
